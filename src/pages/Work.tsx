  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore Hemanth Sayimpu's projects, showcasing expertise in web development, AI, and backend services."
        />
        <meta
          name="keywords"
          content="projects, portfolio, developer, react, node.js, ai"
        />
      </Helmet>
