...
export const usePortfolioStore = create<PortfolioState>((set, get) => {
  ...
  state.hero.ctaLink = isValidUrl(state.hero.ctaLink) ? state.hero.ctaLink : '/';
  state.work.projects.forEach((project) => {
    project.githubUrl = isValidUrl(project.githubUrl) ? project.githubUrl : '#';
    project.mediumPostUrl = isValidUrl(project.mediumPostUrl) ? project.mediumPostUrl : '#';
    project.projectPageUrl = isValidUrl(project.projectPageUrl) ? project.projectPageUrl : '/';
  });
