  ...
  about: {
    ...
    cards: [
      ...
      },
      {
        ...
        title: 'Turning Point',
        content:
          'It all started with a broken login page. What began as a bug fix spiraled into late nights exploring DOM trees and JS quirks. That moment flipped my world.',
      ...
      },
      {
        ...
        content:
          'I love pulling things apart—whether it’s a UI glitch or a weird API response. Debugging feels like a puzzle, and I enjoy finding the cleanest fix.',
        bgColor: 'bg-rose-50',
        textColor: 'text-gray-900',
        size: Size.Large,
        icon: Wrench,
      },
      {
        ...
        content:
          'I admire clean, minimal code—just like a well-composed photo. Simplicity breeds clarity, and that’s how I like my functions and components.',
      ...
      },
      {
        ...
        content:
          'There’s something thrilling about sprinting through a 24-hour build. You learn fast, think faster, and somehow still write decent code by 4 AM.',
        bgColor: 'bg-pink-50',
        textColor: 'text-gray-900',
        size: Size.Medium,
        icon: Clock,
      ...
      },
      {
        ...
        content:
          'Some of my best ideas come from building for fun—like that budgeting app I built just to understand local storage and animations.',
        bgColor: 'bg-lime-50',
        textColor: 'text-gray-900',
        size: Size.Large,
        icon: Lightbulb,
